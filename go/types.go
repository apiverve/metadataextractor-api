// Package metadataextractor provides a Go client for the Metadata Extractor API.
//
// For more information, visit: https://apiverve.com/marketplace/metadataextractor?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the Metadata Extractor API.
//
// Parameters:
//   - url (required): string - The URL of the web page to extract metadata from [format: url]
type Request struct {
...
// ResponseData contains the data returned by the Metadata Extractor API.
type ResponseData struct {
	...
	Msapplication-TileColor string `json:"msapplication-TileColor"`
	Msapplication-TileImage string `json:"msapplication-TileImage"`
	P:domainVerify string `json:"p:domain_verify"`
}
