...
namespace APIVerve\Metadataextractor;
...
/**
 * Client for the Metadata Extractor API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/metadataextractor?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/metadataextractor';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\MetadataextractorClient] {$message}\n";
        }
    }
}
